use crate::{
    ...
    primitives::{CliOptions, MemberAnswer, ResponseTime, Tag, TeamAnswers},
};

pub fn parse_answers(
    answers: APIResponse,
    answers_by_member_vec: &mut Vec<MemberAnswer>,
    ...
    for answer in &answers.items {
        ...
        if team_members.contains(&answer.owner.user_id.unwrap_or(0)) {
            ...
            let aux = TeamAnswers::new(1, answer.score, answer.is_accepted.unwrap_or(false) as u32);
